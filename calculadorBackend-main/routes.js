let controller_calculadoramongo = require('./controller_calculadoramongo')
...
module.exports = (app)=>{
    ...
    app.put('/api/nuevaoperacion', controller_calculadoramongo.Guardar);
    app.post('/api/modificaroperacion', controller_calculadoramongo.Modificar);
    app.delete('/api/eliminaoperacion', controller_calculadoramongo.Eliminar);
    // app.get('/todaslasoperaciones', controller_calculadoramongo.Seleccionartodos);
    // app.post('/operacionporID', controller_calculadoramongo.SeleccionarporID);
